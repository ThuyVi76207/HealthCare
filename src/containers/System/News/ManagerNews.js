    ...
    render() {
        return (
            <div className='manage-specialty-container'>
                <div className='ms-title'>Quản lý bài đăng</div>
                {/* <div className='btn-add-new-specialty'>
                    <button>Add new</button>
                </div> */}
                <div className='add-new-news row'>
                    <div className='col-6 form-group'>
                        <label className='mb-[5px] text-[1.1rem] font-medium'>Tên bài đăng</label>
                    ...
                    <div className='col-6 form-group'>
                        <label className='mb-[5px] text-[1.1rem] font-medium'>Ảnh bài đăng</label>
